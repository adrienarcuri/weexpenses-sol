...
contract WeExpenses {
    ...
    function createParticipant(string _name, address _waddress) public onlyByParticipant() {
    ...
    function createExpense(string _title, uint _amount, uint _valueDate, address[] _payees) public onlyByParticipant() {
    ...
    function isDuplicateInpayees(address[] list) internal pure returns (bool) {
        uint counter;
